  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        display: ["var(--font-geist-sans)", "system-ui", "-apple-system", "BlinkMacSystemFont", "Segoe UI", "Roboto", "Helvetica Neue", "Arial", "sans-serif"],
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow-light": {
          ...
          "50%": {
            boxShadow: "0 0 15px rgba(0, 0, 0, 0.5), 0 0 30px rgba(0, 0, 0, 0.3)",
          },
        },
        "scan-line": {
      ...
      animation: {
        ...
        "pulse-glow-light": "pulse-glow-light 2s infinite",
        "scan-line": "scan-line 2s linear infinite",
        "text-glow": "text-glow 2s infinite",
        "text-glow-light": "text-glow-light 2s infinite",
      ...
      backgroundImage: {
        ...
        "mono-diagonal-light":
          "repeating-linear-gradient(45deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1) 1px, transparent 1px, transparent 10px)",
        "mono-radial":
        ...
        "radial-gradient-light": "radial-gradient(circle at center, #f5f5f5 0%, #e0e0e0 100%)",
      },
    },
  },
